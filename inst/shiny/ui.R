...
ui <- navbarPage(theme=shinythemes::shinytheme('sandstone'), id='tabs', collapsible=TRUE,
                 ...
                 fluidRow(column(3,
                                 conditionalPanel("input.tabs == 1",
                                                  ...
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>2. Select data source<b>")),
                                                  ...
                                                  conditionalPanel("input.occSel == 'user'",
                                                                   ...
                                                                   fileInput("user.occs", "Select occurrence file:")
                                                  ),
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>Clean occurrence data (optional)<b>")),
                                 ...
                                 conditionalPanel("input.tabs==2",
                                                  h4(HTML("<b>3. Select environmental data source:<b>")),
                                                  ...
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>Reduce colinearity (optional)<b>")),
                                 ...
                                 conditionalPanel("input.tabs == 3",
                                                  ...
                                                  actionButton(inputId="sel.cells", label="Select sites"),
                                                  actionButton(inputId="reset.sel.cells", "Reset selection"),
                                                  downloadButton("downloadFilteredTable", ""),
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>6. Configure GDM and run<b>")),
                                 ...
                                 conditionalPanel("input.tabs == 4",
                                                  h4(HTML("<b>7. Find complementary sites:<b>")),
                                                  ...
                                                  actionButton("run.ed","Compute ED"),
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>8. Iterative site selection:<b>")),
                                                  conditionalPanel("input.edSel=='ed.all'",
                                                                   radioButtons("edAction", "Select action & press go to find next site:",choices=list("Add"='ed.add',"Reject"='ed.reject',"Modify"='ed.modify'), inline =T)),
                                                  conditionalPanel("input.edSel=='ed.some'",
                                                                   radioButtons("edAction", "Select action & press go to find next site:",choices=list("Add"='ed.add',"Reject"='ed.reject'), inline =T)),
                                                  ...
                                                  HTML('<hr>'),
                                                  h4(HTML("<b>Download results (optional):")),
